...
# GOOGLE SHEET
# ---------------------------------------------------------------------------
ID_SHEET   = '1HFq4DxP14dXOPgqYsO7MLQIQr1C1dRaM1Vvfrpi9kSE'
...
COLUMN_RENAME_MAP = {
    ...
    'Existe registro de HC':                     'existeRegistroHC',
    'Solicitud ordenada con la frecuencia justa y no redundante': 'solicitudFrecuenciaJusta',
    'Pertinencia':                               'pertinencia',
    'Resolutividad':                             'resolutividad',
    'Remision original pertinente':              'remisionOriginalPertinente',
    'indique si la reconsulta o impertinencia  fue causa administrativa': 'reconsultaCausaAdministrativa',
    'Nota':                                      'nota',
...
def execution_load():
    ...
    log.info('=' * 60)
    log.info(f'Inicio del ETL: externos')
