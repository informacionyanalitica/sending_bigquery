...
table_name                      = 'consultasEspecialistas'
TABLA_BIGQUERY                  = f'{project_id_product}.{dataset_id_gestion_conocimiento}.{table_name}'

# ---------------------------------------------------------------------------
# GOOGLE SHEET
# ---------------------------------------------------------------------------
ID_SHEET   = '1viMp4tNSWDgkgNLaZmSidFK9tUlC8zrjHEjtIt_2HpE'
NAME_SHEET = 'Ingreso'
...
COLUMN_RENAME_MAP = {
    ...
    'El especialista es quien carga la orden?': 'ordenSegunModelo',
    ...
    'Datos Administrativos':                    'datosAdministrativos',
...
PCT_COLS = ['datosAdministrativos', 'atencionMedica', 'resolutividad']
...
def execution_load():
    ...
    log.info('=' * 60)
    log.info(f'Inicio del ETL: consultasEspecialistas')
