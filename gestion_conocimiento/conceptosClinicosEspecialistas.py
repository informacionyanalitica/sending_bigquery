...
table_name                      = 'conceptosClinicosEspecialistas'
TABLA_BIGQUERY                  = f'{project_id_product}.{dataset_id_gestion_conocimiento}.{table_name}'

# ---------------------------------------------------------------------------
# GOOGLE SHEET
# ---------------------------------------------------------------------------
ID_SHEET   = '1XZABWi7DYW-53bpj5Rl-6FRHxqDn7x6IaRP6dUmi4DQ'
...
COLUMN_RENAME_MAP = {
    ...
    'Solicita Examenes':                        'solicitaExamenes',
    'Da Recomendaciones':                       'daRecomendaciones',
    'Historia Incompleta':                      'historiaIncompleta',
    'Direcciona a Cita Presencial':              'direccionaCitaPresencial',
    'Cita con otra Especialidad':                'citaOtraEspecialidad',
    'Adecuada':                                 'adecuada',
...
def execution_load():
    ...
    log.info('=' * 60)
    log.info(f'Inicio del ETL: conceptosClinicosEspecialistas')
